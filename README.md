	...
	<h:body>
		<h:form id="frm">
			...
			<h:panelGrid columns="2">
				...
				<h:panelGroup>
					<h:inputText size="50"/>
					<h:graphicImage value="/img/ajuda.png"/>
				</h:panelGroup>
		...
		<h:form id="frm">
			...
			<h:dataTable value="#{consultaClienteBean.clientes}" var="item" 
				...
				<h:column>
					...
					<h:outputText value="#{item.cidade}"/>
					<h:outputLink value="https://www.google.com.br/search?tbm=isch&amp;q=#{item.cidade}">
						<h:graphicImage value="/imagens/fotos.png"/>
					</h:outputLink>
				</h:column>
...
<html xmlns="http://www.w3.org/1999/xhtml"
	...
	<h:body>
		<h:form id="frm">
			<h:dataTable value="#{consultaClienteBean.clientes}" var="item" 
					border="0" cellpadding="2" cellspacing="0"
					width="500" styleClass="tabela" headerClass="cabecalho"
					rowClasses="linha1, linha2">
				...
				<h:column>
					...
					<h:outputText value="#{item.cidade}"/>
					<h:graphicImage value="/img/fotos.png"
						onclick="selecionarCidade('#{item.cidade}')"/>
				</h:column>
...
<h:body>
    ...
    <h:form id="frm">
        ...
        <h:panelGrid columns="2" styleClass="form-grid" columnClasses="label, campo">
            ...
            <h:selectOneMenu>
                <f:selectItem itemValue="Escola Infantil Abelha Amarela" />
            </h:selectOneMenu>
...
- UsandoValidadores\WebContent\ChecagemEstoque.xhtml
